...
3. **Router (Circuit Breaker):** Checks the evaluation score. If the PRD scores **>= 80** or reaches the maximum revision threshold, the loop terminates; otherwise, it passes the feedback back to the Writer for a targeted update.
...
### 🗂️ Project Structure
To keep your development environment organized, your repository should be structured as follows:
```text
├── agent_workflow.ipynb   # Main Jupyter Notebook containing all 5 cells
├── README.md              # Project documentation and architectural overview
└── .env                   # Local environment variable configuration (optional)